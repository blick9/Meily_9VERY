...
//        dateFormatter.timeStyle = .none
    ...
    @IBAction func saveButtonAction(_ sender: Any) {
        if goalTitleTextField.text?.isEmpty == true {
            ...
            let addGoalDataInstance = Goal(image: previewImage.image!, title: goalTitleTextField.text!, dueDate: datePicker.date, priority: priorityValue, colorTag: colorTagValue, pictogram: pictogramValue, id: makeID.string(from: Date()))
